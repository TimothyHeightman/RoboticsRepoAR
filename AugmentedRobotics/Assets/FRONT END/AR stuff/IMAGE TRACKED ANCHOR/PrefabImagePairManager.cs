    ...
    public class PrefabImagePairManager : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        void AssignPrefab(ARTrackedImage trackedImage)
        {
            if (m_PrefabsDictionary.TryGetValue(trackedImage.referenceImage.guid, out var prefab))
            {
                ...
                //var x_scale = m_Instantiated[trackedImage.referenceImage.guid].transform.localScale.x;
                //trackedImage.transform.localScale = new Vector3(1, 1, 1);
            };
        }
        ...
        public void SetPrefabForReferenceImage(XRReferenceImage referenceImage, GameObject alternativePrefab)
        {
            ...
            if (m_Instantiated.TryGetValue(referenceImage.guid, out var instantiatedPrefab))
            {
                ...
                //m_Instantiated[referenceImage.guid] = Instantiate(alternativePrefab, instantiatedPrefab.transform.position, instantiatedPrefab.transform.rotation);
                //m_Instantiated[referenceImage.guid].transform.localScale = instantiatedPrefab.transform.localScale;
                ////var x_scale = m_Instantiated[referenceImage.guid].transform.localScale.x;
